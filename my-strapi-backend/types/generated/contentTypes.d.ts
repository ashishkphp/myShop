...
export interface ApiAllServiceAllService extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::all-service.all-service'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    Services: Schema.Attribute.Component<'services.services-list', true>;
    servicesectiondescription: Schema.Attribute.Text;
    servicesectiontitle: Schema.Attribute.String;
    title: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiFacebookReviewFacebookReview
  extends Struct.CollectionTypeSchema {
  collectionName: 'facebook_reviews';
  info: {
    displayName: 'Facebook Reviews';
    pluralName: 'facebook-reviews';
    singularName: 'facebook-review';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    defaultText: Schema.Attribute.String;
    facebookImage: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::facebook-review.facebook-review'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiHomeHome extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    FAQs: Schema.Attribute.Component<'faqs.fa-qs', true>;
    ...
    Suburb: Schema.Attribute.Component<'suburbs.suburb-list', true>;
    suburbdescription: Schema.Attribute.Text;
    suburbs: Schema.Attribute.Relation<'oneToMany', 'api::suburb.suburb'>;
    suburbtitle: Schema.Attribute.String;
    TItle: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::all-service.all-service': ApiAllServiceAllService;
      'api::blog-category.blog-category': ApiBlogCategoryBlogCategory;
      'api::blog.blog': ApiBlogBlog;
      'api::facebook-review.facebook-review': ApiFacebookReviewFacebookReview;
